...
![Adalab](https://firebasestorage.googleapis.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LZZ7_HREMZMUMXiWrCj%2F-LZZ7xHB1bnkIxUrw_Yx%2F-LZZ83Upae8RuHPxHpB8%2Fadalab_brand.png?generation=1551089555419087&alt=media)
 ...
 <img className="landing-logo" src={logoCodeLanding} alt="Awesome Profile Cards Logo" title="Awesome Profile-Cards" />
...
## Equipo
👩🏻 | Laura García | `'Dip in Leadership'` | [GitHub](https://github.com/laurageeme) 

💻 | Maite Villar | `'Gimmie a Challenge!'` | [GitHub](https://github.com/maitevillar)

💃 | Ana Valdivia | `'Getting Things Done'` | [GitHub](https://github.com/Anavalca) 

🛡 🛡 | Liliana Rascón | `'Meet the Charm'` | [GitHub](https://github.com/LiliRascon) 

🐎 | Mercy Grace | `'Means to Creativity'` | [GitHub](https://github.com/mgracesb) 
